...
b. Run the command "bundle install" from the Code directory.
...
5. How to run:
==========================
a. From Code/ directory, run server with "ruby lib/server.rb". CTRL+C to close server process.
f. From Code/ directory, run client with "ruby lib/client.rb".
